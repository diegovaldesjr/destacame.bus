...
export default {
    ...
    methods: {
        onSubmit(event) {
            ...
            axios.put(path, horario).then((response => {
        ...
        getHorario() {
            ...
            axios.get(path).then((response => {
                this.form.bus = response.data.bus
                this.form.fecha = response.data.fecha.substring(0,10)
                this.form.hora = response.data.fecha.substring(11,19)
